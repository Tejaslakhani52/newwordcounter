...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (caseType === "Sentence case") {
      formattedText = newText.replace(/(^|\. *)([a-z])/g, (match) => {
            ...
            >
              ...
              <div className="max-lg:hidden justify-between items-center">
                <p className="text-[14px] opacity-70">
                  TWITTER{" "}
                  <i className="fa-brands fa-twitter text-[#00acee] mx-2"></i>
                </p>
                <h2 className="text-[20px] font-semibold mt-1 flex items-center">
                  <i className="fa-solid fa-circle text-[12px] mx-2 text-[#00acee]"></i>
                  {280 - charCount}/
              ...
              <div className="max-lg:hidden justify-between items-center">
                <p className="text-[14px] opacity-70">
                  FACEBOOK{" "}
                  <i className="fa-brands fa-facebook-f text-[#3b5998] mx-2"></i>
                </p>
                <h2 className="text-[20px] font-semibold mt-1 flex items-center">
                  <i className="fa-solid fa-circle text-[12px] mx-2 text-[#3b5998]"></i>
                  {250 - charCount}/
              ...
              <div className="max-lg:hidden justify-between items-center">
                <p className="text-[14px] opacity-70">
                  GOOGLE{" "}
                  <i className="fa-brands fa-google text-[#db3236] mx-2"></i>
                </p>
                <h2 className="text-[20px] font-semibold mt-1 flex items-center">
                  <i className="fa-solid fa-circle text-[12px] mx-2 text-[#db3236]"></i>
                  {300 - charCount}/
              ...
              >
                ...
                >
                  <div className="flex items-center justify-end gap-[5px]">
                    ...
                    >
                      <i className="fa-regular fa-clipboard text-[25px] opacity-100"></i>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-[7px]">
                    <p className="text-[14px] opacity-70">Speaking:</p>
            ...
            >
              <div className="flex items-center gap-[7px]">
                <div className="  cursor-pointer" onClick={handleCopyClick}>
                  <i className="fa-solid fa-clipboard text-[20px] opacity-60"></i>
                </div>
              </div>
              <div className="flex items-center gap-[7px]">
                <p className="text-[14px] opacity-70">Pages:</p>
